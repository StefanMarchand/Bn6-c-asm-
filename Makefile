...
CSRCS := $(CDIR)/asm00_0_sub_8000C5C.c $(CDIR)/asm00_0_shuffle_rng.c $(CDIR)/asm00_0_sound.c $(CDIR)/ai/asm00_0_soundmain.c $(CDIR)/asm00_0_playsfx.c $(CDIR)/asm00_0_playmusic.c $(CDIR)/asm00_0_music_80005F2.c $(CDIR)/asm00_0_sub_800060A.c $(CDIR)/asm00_0_sound_8000642.c $(CDIR)/asm00_0_sound_800065A.c $(CDIR)/asm00_0_sound_8000672.c $(CDIR)/asm00_0_sound_800068A.c $(CDIR)/asm00_0_sound_80006A2.c $(CDIR)/asm00_0_musicGameState_8000784.c $(CDIR)/asm00_0_sub_80007A0.c $(CDIR)/asm00_0_zeroFill_80007B2.c $(CDIR)/asm00_0_mem_utils.c $(CDIR)/asm00_0_sound_8000808.c $(CDIR)/asm00_0_sub_8000E28.c $(CDIR)/asm00_0_sub_8000E30.c $(CDIR)/asm00_0_sub_8000F86.c $(CDIR)/asm00_1_sub_800318C.c $(CDIR)/asm00_1_runbattleobjectlogic.c $(CDIR)/asm00_2_sub_800ED80.c $(CDIR)/asm00_2_sub_800ED90.c $(CDIR)/chips/asm00_2_chip_helpers.c $(CDIR)/chips/asm02_chip_pack.c $(CDIR)/battle_core_loadchipdata.c $(CDIR)/ai/menu_core_initmainmenu.c $(CDIR)/asm01_menu_transfer_helpers.c $(CDIR)/asm03_0_beast_scan_helpers.c $(CDIR)/asm03_0_beast_panel_helpers.c $(CDIR)/asm03_0_beast_search_wrappers.c $(CDIR)/asm03_2_text_render_wrappers.c $(CDIR)/asm03_2_text_sprite_wrappers.c $(CDIR)/asm03_2_text_sprite_reset_wrappers.c $(CDIR)/asm03_2_text_sprite_clear_wrappers.c $(CDIR)/asm03_2_text_sprite_clear_8046696.c $(CDIR)/asm03_2_text_sprite_secondary_clear.c $(CDIR)/asm04_centraltown_entermapgroup.c $(CDIR)/asm04_centraltown_loadgfxanims.c $(CDIR)/asm04_centraltown_spawn.c $(CDIR)/asm05_cyberacademy_entermapgroup.c $(CDIR)/asm05_cyberacademy_loadgfxanims.c $(CDIR)/asm05_cyberacademy_spawn.c $(CDIR)/asm06_seasidetown_entermapgroup.c $(CDIR)/asm06_seasidetown_loadgfxanims.c $(CDIR)/asm06_seasidetown_spawn.c $(CDIR)/asm07_greentown_entermapgroup.c $(CDIR)/asm07_greentown_loadgfxanims.c $(CDIR)/asm07_greentown_spawn.c $(CDIR)/asm08_skytown_entermapgroup.c $(CDIR)/asm08_skytown_loadgfxanims.c $(CDIR)/asm08_skytown_spawn.c $(CDIR)/asm09_exposite_entermapgroup.c $(CDIR)/asm09_exposite_loadgfxanims.c $(CDIR)/asm09_exposite_spawn.c
C_PPS := $(CSRCS:.c=.i)
C_ASM := $(CSRCS:.c=.s)
C_OFILES := $(CSRCS:.c=.o)
BUILD_NAME = bn6f
...
$(CDIR)/asm03_0_beast_search_wrappers.i: $(CDIR)/asm03_0_beast_search_wrappers.c $(INC)/asm03_0_beast_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/chips/asm02_chip_pack.i: $(CDIR)/chips/asm02_chip_pack.c $(INC)/chips/asm02_chip_pack.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm03_1_0_sub_80341AA.i: $(CDIR)/asm03_1_0_sub_80341AA.c $(INC)/asm03_1_0_small_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm03_1_0_jackin_state_wrappers.i: $(CDIR)/asm03_1_0_jackin_state_wrappers.c $(INC)/asm03_1_0_small_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm03_1_0_sub_80355DE.i: $(CDIR)/asm03_1_0_sub_80355DE.c $(INC)/asm03_1_0_small_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm03_1_0_sub_80356EC.i: $(CDIR)/asm03_1_0_sub_80356EC.c $(INC)/asm03_1_0_small_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm03_2_text_sprite_clear_wrappers.i: $(CDIR)/asm03_2_text_sprite_clear_wrappers.c $(INC)/asm03_2_text_sprite_clear_wrappers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm03_2_text_sprite_secondary_clear.i: $(CDIR)/asm03_2_text_sprite_secondary_clear.c $(INC)/asm03_2_text_sprite_secondary_clear.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm04_centraltown_entermapgroup.i: $(CDIR)/asm04_centraltown_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm05_cyberacademy_entermapgroup.i: $(CDIR)/asm05_cyberacademy_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm06_seasidetown_entermapgroup.i: $(CDIR)/asm06_seasidetown_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/asm07_greentown_entermapgroup.i: $(CDIR)/asm07_greentown_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm07_greentown_loadgfxanims.i: $(CDIR)/asm07_greentown_loadgfxanims.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm07_greentown_spawn.i: $(CDIR)/asm07_greentown_spawn.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm08_skytown_entermapgroup.i: $(CDIR)/asm08_skytown_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm08_skytown_loadgfxanims.i: $(CDIR)/asm08_skytown_loadgfxanims.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm08_skytown_spawn.i: $(CDIR)/asm08_skytown_spawn.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm09_exposite_entermapgroup.i: $(CDIR)/asm09_exposite_entermapgroup.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm09_exposite_loadgfxanims.i: $(CDIR)/asm09_exposite_loadgfxanims.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@

$(CDIR)/asm09_exposite_spawn.i: $(CDIR)/asm09_exposite_spawn.c $(INC)/mapgroup_spawn_helpers.h
	$(CPP) -undef -nostdinc -I$(INC) $< -o $@
...
$(CDIR)/chips/asm02_chip_pack.s: $(CDIR)/chips/asm02_chip_pack.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm02_chip_pack_rominc.py $@
...
$(CDIR)/asm03_0_beast_search_wrappers_rominc.s: $(CDIR)/asm03_0_beast_search_wrappers.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_0_beast_search_wrappers_rominc.py $@
...
$(CDIR)/asm03_1_0_sub_80341AA_rominc.s: $(CDIR)/asm03_1_0_sub_80341AA.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_1_0_sub_80341AA_rominc.py $@

$(CDIR)/asm03_1_0_jackin_state_wrappers_rominc.s: $(CDIR)/asm03_1_0_jackin_state_wrappers.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_1_0_jackin_state_wrappers_rominc.py $@

$(CDIR)/asm03_1_0_sub_80355DE_rominc.s: $(CDIR)/asm03_1_0_sub_80355DE.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_1_0_sub_80355DE_rominc.py $@

$(CDIR)/asm03_1_0_sub_80356EC_rominc.s: $(CDIR)/asm03_1_0_sub_80356EC.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_1_0_sub_80356EC_rominc.py $@
...
$(CDIR)/asm03_2_text_sprite_clear_804668A_rominc.s: $(CDIR)/asm03_2_text_sprite_clear_wrappers.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_2_text_sprite_clear_804668A_rominc.py $@

$(CDIR)/asm03_2_text_sprite_clear_80466AA_rominc.s: $(CDIR)/asm03_2_text_sprite_clear_wrappers.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_2_text_sprite_clear_80466AA_rominc.py $@
...
$(CDIR)/asm03_2_text_sprite_clear_80468E0_rominc.s: $(CDIR)/asm03_2_text_sprite_secondary_clear.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_asm03_2_text_sprite_clear_80468E0_rominc.py $@

$(CDIR)/asm04_centraltown_entermapgroup.s: $(CDIR)/asm04_centraltown_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ CentralTown_EnterMapGroup
...
$(CDIR)/asm05_cyberacademy_entermapgroup.s: $(CDIR)/asm05_cyberacademy_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ CyberAcademy_EnterMapGroup
...
$(CDIR)/asm06_seasidetown_entermapgroup.s: $(CDIR)/asm06_seasidetown_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ SeasideTown_EnterMapGroup
...
$(CDIR)/asm07_greentown_entermapgroup.s: $(CDIR)/asm07_greentown_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ GreenTown_EnterMapGroup

$(CDIR)/asm07_greentown_loadgfxanims.s: $(CDIR)/asm07_greentown_loadgfxanims.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_loadgfxanims.py $@ GreenTown_LoadGFXAnims off_805DFB0 off_805DFB4

$(CDIR)/asm07_greentown_spawn.s: $(CDIR)/asm07_greentown_spawn.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_spawn.py $@ GreenTown_SpawnMapObjectsForMap off_805E004 pt_805E008

$(CDIR)/asm08_skytown_entermapgroup.s: $(CDIR)/asm08_skytown_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ SkyTown_EnterMapGroup

$(CDIR)/asm08_skytown_loadgfxanims.s: $(CDIR)/asm08_skytown_loadgfxanims.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_loadgfxanims.py $@ SkyTown_LoadGFXAnims off_8060414 off_8060418

$(CDIR)/asm08_skytown_spawn.s: $(CDIR)/asm08_skytown_spawn.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_spawn.py $@ SkyTown_SpawnMapObjectsForMap off_8060460 pt_8060464

$(CDIR)/asm09_exposite_entermapgroup.s: $(CDIR)/asm09_exposite_entermapgroup.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_entermapgroup.py $@ ExpoSite_EnterMapGroup

$(CDIR)/asm09_exposite_loadgfxanims.s: $(CDIR)/asm09_exposite_loadgfxanims.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_loadgfxanims.py $@ ExpoSite_LoadGFXAnims off_8062B74 off_8062B78

$(CDIR)/asm09_exposite_spawn.s: $(CDIR)/asm09_exposite_spawn.i
	$(AGBCC) -O2 -mthumb-interwork $< -o $@
	python3 tools/fix_agbcc_mapgroup_spawn.py $@ ExpoSite_SpawnMapObjectsForMap off_8062BE0 pt_8062BE4
