...
CSRCS := $(CDIR)/asm00_0_sound.c $(CDIR)/asm00_0_soundmain.c $(CDIR)/asm00_0_playsfx.c $(CDIR)/asm00_0_playmusic.c $(CDIR)/asm00_0_music_80005F2.c $(CDIR)/asm00_0_sub_800060A.c $(CDIR)/asm00_0_sound_8000642.c $(CDIR)/asm00_0_sound_800065A.c $(CDIR)/asm00_0_sound_8000672.c $(CDIR)/asm00_0_sound_800068A.c $(CDIR)/asm00_0_zeroFill_80007B2.c $(CDIR)/asm00_2_sub_800ED80.c
C_PPS := $(CSRCS:.c=.i)
C_ASM := $(CSRCS:.c=.s)
C_OFILES := $(CSRCS:.c=.o)
BUILD_NAME = bn6f
