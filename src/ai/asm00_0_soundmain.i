# 0 "src/ai/asm00_0_soundmain.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/ai/asm00_0_soundmain.c"
# 1 "include/asm00_0_sound.h" 1
...
int sub_814EAF0(void);
int sub_814EB1C(void);
...
# 2 "src/ai/asm00_0_soundmain.c" 2
